<h2><a href="https://leetcode.com/problems/removing-minimum-number-of-magic-beans/">2171. Removing Minimum Number of Magic Beans</a></h2><h3>Medium</h3><hr><div><p>You are given an array of <strong>positive</strong> integers <code>beans</code>, where each integer represents the number of magic beans found in a particular magic bag.</p>
...
<pre><strong>Input:</strong> beans = [4,1,6,5]
...
<pre><strong>Input:</strong> beans = [2,10,3,2]
